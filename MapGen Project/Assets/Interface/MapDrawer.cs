...
public class MapDrawer : MonoBehaviour
{
    ...
    public Dictionary<Loc, GameObject> Tiles;
    ...
    void Start()
    {
        Tiles = new Dictionary<Loc, GameObject>();
    }
    ...
    void ColorElevationSimple(Loc l)
    {
        GameObject go = Tiles[l];
        ResetTile(go);
        float e = mapGen.Elevation[l.x, l.y];
